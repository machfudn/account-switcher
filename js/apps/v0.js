// v0 app definition
// v0's mark is white, so give it a dark icon background so it shows on the
// (light) card instead of being invisible.
APPS.v0 = {
    name: 'v0',
    color: '#000000',
    colorHover: '#222222',
